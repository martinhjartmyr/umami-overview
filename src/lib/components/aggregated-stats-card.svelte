...
<div class="rounded-2xl bg-primary p-4 sm:p-6 lg:p-8">
  <header class="mb-4 flex items-start justify-between gap-4 sm:mb-6 lg:mb-8">
    <div class="flex min-w-0 flex-col gap-1">
      <h2 class="text-base font-bold text-fg sm:text-2xl lg:text-3xl">All Websites</h2>
      <p class="text-xs text-fg-subtle sm:text-sm">Aggregated statistics</p>
    </div>
